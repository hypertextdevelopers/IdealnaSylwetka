<?php
    ...
    if(isset($_SESSION['activehref'])){

        unset($_SESSION['activehref']);
...
<head>
    ...
    <link href="fontello/fontello-fc9edb3f/css/fontello.css" rel="stylesheet" />
...
<body>
    ...
    <?php
        ...
        if(isset($_GET['fieldsError'])){
            echo '<div class="alert alert-warning" style="width:300px; height:50px;">Wypełnij wszystkie pola formularza!</div>';
        }
   ...
   <div id="container">
        ...
        <div id="mainThird">
            ...
            <div id="permissionBox">
                ...
                <div id="bubble"><i class="icon-lock-open-filled"></i></div>

                <div id="permissionBoxText">

                    <img src="graphic/baseline-email-24px.svg" />

                </div> 

                <div id="permissionBoxHeader">

                    <p>Na Twój adres email został wysłany link aktywacyjny.</p>

                </div>

                <div id="permissionBoxAfter">

                    <p>Po kliknięciu w niego zostaniesz przekierowany automatycznie na odblokowaną stronę. Jednocześnie przez najbliższe 4 tygodnie dostaniesz 4 wiadomości przypominające Ci o nowo dodanym materiale. Mam nadzieję, że Ci się spodoba!</p>

                </div>

                <div id="permissionBoxIcon">

                    <img src="graphic/good@2x.png">
